...
public class Hacker extends Joueur {
    ...
    public Hacker(Integer nombreT1, Integer nombreT2, Integer nombreT3, Integer nombreT4, Integer nombreT5, Integer tourDeJeu, Color couleur) {
        super("Mister X", nombreT1, nombreT2, nombreT3, couleur);
        this.nombreT4 = nombreT4;
        this.nombreT5 = nombreT5;
        this.tourDeJeu = tourDeJeu;
    }
